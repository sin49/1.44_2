...
{
	sAsixPoint = D2D1::Point2F(asix.x, asix.y);
}
...
D2D1::Matrix3x2F CTransform::GetRotate()
{
	...
	matRot.m12 = matTransform.m12;
	matRot.m21 = matTransform.m21;
	matRot.m22 = matTransform.m22;
	return matRot;
}
...
void CTransform::SetFlipX(bool flip)
{
	if (flip)
		matTransform.m11 = -abs(matTransform.m11);
	else
		matTransform.m11 = abs(matTransform.m11);
}
